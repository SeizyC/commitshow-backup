# AGENTS.md — commit.show 프로젝트 컨텍스트

> Codex가 이 파일을 읽으면 전체 프로젝트를 즉시 이해하고 작업할 수 있다.
...
> **공개 repo 주의**: github.com/commitshow/commitshow 는 public. 따라서 AGENTS.md 자체는
...
- 단 AGENTS.md §4 디자인 시스템의 emoji 금지 원칙은 **UI 아이콘·지표·버튼 라벨** 한정. Comment 입력 중 사용자가 찍는 감정 태그는 예외 허용.
...
V1 Phase A · P9a (2026-04-24 · 이 AGENTS.md 업데이트)
...
```
✅ PRD v2 재정비 (AGENTS.md · 2026-04-24 commit 20515c1)
